...
export default async function DashboardPage({ params }: Props) {
  ...
  const stats = [
    { label: "Collections", value: totalCollections ?? 0, href: `${base}/collections`, color: "text-brand-600", bg: "bg-brand-50" },
    { label: "Products", value: totalItems ?? 0, href: `${base}/collections`, color: "text-blue-600", bg: "bg-blue-50" },
    { label: "QR Codes", value: totalQrCodes ?? 0, href: `${base}/qr-codes`, color: "text-purple-600", bg: "bg-purple-50" },
    { label: "Scans (7d)", value: scans7d ?? 0, href: `${base}/analytics`, color: "text-amber-600", bg: "bg-amber-50" },
    { label: "Clicks (7d)", value: clicks7d ?? 0, href: `${base}/analytics`, color: "text-emerald-600", bg: "bg-emerald-50" },
  ];
      ...
      <div className="page-header">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Welcome back to <span className="font-medium text-slate-700">{ctx.shop.name}</span>
          </p>
        </div>
      ...
      <div className="grid sm:grid-cols-2 gap-5">
          ...
          <div className="space-y-1">
            {[
              ...
              >
                ...
                <svg className="w-4 h-4 text-slate-300 group-hover:text-brand-500 group-hover:translate-x-0.5 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {[
              { step: "1", text: "Create a collection of recommended products", color: "bg-brand-100 text-brand-700" },
              { step: "2", text: "Paste product links — images & titles auto-fetch", color: "bg-blue-100 text-blue-700" },
              { step: "3", text: "Generate a QR code for the collection", color: "bg-purple-100 text-purple-700" },
              { step: "4", text: "Print and display in your shop", color: "bg-amber-100 text-amber-700" },
              { step: "5", text: "Track scans & clicks in analytics", color: "bg-emerald-100 text-emerald-700" },
            ].map((item) => (
