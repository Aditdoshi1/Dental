        ...
        <div className="flex h-14 items-center justify-between">
              ...
              {editingName ? (
                <div className="flex items-center gap-1.5">
                  <input
                    ...
                    autoFocus
                    className="text-sm font-semibold text-slate-900 bg-white border border-brand-300 rounded-lg px-2 py-1 focus:outline-none focus:ring-2 focus:ring-brand-500 w-36"
                  />
                ...
                <span className="hidden sm:inline font-semibold text-slate-900 group-hover:text-brand-700 transition-colors">
                  {shopName}
                  {(role === "owner" || role === "admin") && (
                    <button onClick={() => setEditingName(true)} className="ml-1.5 text-slate-300 hover:text-slate-500 transition-colors inline-flex align-middle">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 text-[13px] text-slate-400 hover:text-red-600 transition-colors px-2 py-1.5 rounded-lg hover:bg-red-50"
            >
        ...
        {mobileOpen && (
          <div className="md:hidden pb-3 pt-1 animate-fade-in">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <button
                onClick={handleSignOut}
                className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium text-red-500 hover:bg-red-50 w-full text-left"
              >
